...
import DriverTripOverview from './pages/DriverTripOverview';
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/driver/trip/:id" element={<ProtectedDriverRoute><DriverLayout><DriverTripOverview /></DriverLayout></ProtectedDriverRoute>} />
